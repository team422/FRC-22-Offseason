...
public class SwerveModule extends SubsystemBase {
     ...
     * @param turningCANCoder Turning CANCoder
     * @param turningCANCoderOffsetDegrees The offset of the CANCoder in degrees.
     * @param driveEncoder The encoder for the drive motor.
     * @param turningEncoder The encoder for the turning motor.
     */
    public SwerveModule(
        ...
        this.m_turningMotor = turningMotor;
        this.m_turningCANCoder = turningCANCoder;

        this.m_driveEncoder = driveEncoder;
        this.m_turningEncoder = turningEncoder;
        this.m_turningController = turningController;
    ...
    public void setDesiredState(SwerveModuleState state) {
        ...
        m_driveController.setReference(driveOutput, CANSparkMax.ControlType.kVelocity, 0,
                Constants.ModuleConstants.kDriveFF * driveOutput);
    }
    ...
    public void syncTurningEncoders() {
        m_turningEncoder.setPosition(m_turningCANCoder.getDistance());
    }
